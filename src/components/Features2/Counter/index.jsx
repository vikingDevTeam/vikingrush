            ...
            <div className="counter-down">
              <div className="content">
                <div className="conuter-header">
                  <h3 className="w-text text-center">TOKEN PRIVATE SALE ENDS IN</h3>
                </div>
                <div className="counterdown-content">
                  <div className="count-down titled circled text-center">
                    <SlideCountdown
                      weeks={false}
                      deadline="2022-2-13 00:00:00" />
                  </div>
                  <div className="ico-progress">
                    <ul className="list-unstyled list-inline clearfix mb-10">
                      <li className="title">20 BNB</li>
                      <li className="strength">65 BNB</li>
                    </ul>
                    <div className="current-progress">
                      <Line percent="0" trailWidth="3" strokeWidth="4" strokeColor="#fb881d" />
                    </div>
